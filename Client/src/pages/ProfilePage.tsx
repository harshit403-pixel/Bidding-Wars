...
import { Gavel, Trophy, Package, CheckCircle2, CreditCard, ExternalLink } from "lucide-react";
        ...
        <div className="min-h-screen bg-[#F5F1EB] text-[#111111]">
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 md:px-8">
                ...
                <div className="mb-8 border border-neutral-200 bg-white p-6 sm:p-8 md:p-10">
                    ...
                    {/* Quick Stats Grid */}
                    <div className="mt-8 grid grid-cols-2 gap-4 border-t border-neutral-200 pt-6 sm:grid-cols-3 sm:gap-6">
                        ...
                        <div className="col-span-2 bg-neutral-50 p-4 text-center sm:col-span-1">
                            <Gavel className="mx-auto mb-1 h-5 w-5 text-[#FF3B00]" />
                            <p className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 sm:text-xs">
                                Account Status
                            </p>
                            <p className="mt-1 text-sm font-semibold uppercase text-emerald-600">
                                Active
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                {myAuctions.map((auction) => (
                                    <Link
                                        key={auction._id}
                                        to={`/auction/${auction.roomId}`}
                                        className="flex items-center justify-between border border-neutral-200 bg-white p-5 transition hover:shadow-md"
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h3 className="font-bold text-neutral-900">{auction.title}</h3>
